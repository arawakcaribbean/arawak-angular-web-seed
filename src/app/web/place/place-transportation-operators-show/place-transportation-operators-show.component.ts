...
import { TransportationOperators } from 'src/core/_models/entity/transportation-operators';
...
@Component({
  selector: 'place-transportation-operators-show',
  templateUrl: './place-transportation-operators-show.component.html',
  styleUrls: ['./place-transportation-operators-show.component.css']
})
export class PlaceTransportationOperatorsShowComponent extends BaseComponent implements OnInit {
  data: TransportationOperators
  isLoading: boolean
