...
import { Attraction } from 'src/core/_models/entity/attraction';
...
@Component({
  selector: 'place-atraction-show',
  templateUrl: './place-atraction-show.component.html',
  styleUrls: ['./place-atraction-show.component.css']
})
export class PlaceAtractionShowComponent extends BaseComponent implements OnInit {
  data: Attraction
  isLoading: boolean
