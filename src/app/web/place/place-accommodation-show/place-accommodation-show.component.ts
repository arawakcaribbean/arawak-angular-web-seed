...
import { Accommodation } from 'src/core/_models/entity/accommodation';
...
@Component({
  selector: 'place-accommodation-show',
  templateUrl: './place-accommodation-show.component.html',
  styleUrls: ['./place-accommodation-show.component.css']
})
export class PlaceAccommodationShowComponent extends BaseComponent implements OnInit {
  data: Accommodation
  isLoading: boolean
